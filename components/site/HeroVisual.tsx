  ...
  return (
    ...
    >
      ...
      <svg className="absolute inset-0 h-full w-full" viewBox="0 0 600 420">
        <path
          d="M60 310 C170 120 280 360 420 140 S540 170 560 80"
          fill="none"
          stroke="#059669"
          strokeWidth="4"
          strokeLinecap="round"
        ...
        {[
          ...
          <circle key={i} cx={cx} cy={cy} r="8" fill="#10b981">
            <animate
              attributeName="r"
              values="6;10;6"
              dur="3s"
      ...
      <div className="relative ml-auto grid max-w-sm gap-3 pt-12">
        <div className="rounded-3xl bg-white/80 p-4 shadow-xl backdrop-blur">
          ...
          <p className="text-xs leading-relaxed text-slate-600">
            Questions, leads, bookings, documents
          </p>
        </div>
        <div className="ml-8 rounded-3xl bg-emerald-950 p-4 text-white shadow-xl">
        ...
        <div className="ml-16 rounded-3xl bg-white/90 p-4 shadow-xl">
          ...
          <p className="text-xs leading-relaxed text-slate-600">
            CRM update • appointment • report • human review
          </p>
        </div>
      </div>
    </div>
